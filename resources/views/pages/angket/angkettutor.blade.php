				...
				<div class="container">
					<div class="row">
						<div class="col s10 m6 l6 breadcrumbs-left">
							<h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>Data Tutorial</span>
							</h5>
										...
										<div class="col s12">
											<div class="col s12 m4 l4">
												...
												<select class="select2 browser-default" name="jenis" id="jenis">
													<option value="idnamatutor"
													        @if(!empty($jenis))@if($jenis == "idnamatutor") selected @endif @endif >
														ID Tutor / Nama Tutor
													</option>
													<option value="masa"
													        @if(!empty($jenis))@if($jenis == "masa") selected @endif @endif >
														Masa
													</option>
													<option value="matakuliah"
													        @if(!empty($jenis))@if($jenis == "matakuliah") selected @endif @endif >
														Kode Matakuliah
													</option>
												</select>
										...
										<div class="col s12 m12 l12">
											...
											<div class="row">
												<div class="input-field col s12 m12 l12">
													...
													<input placeholder="" name="tutor" id="tutor" type="text"
													       value="{{$data_array[0]['id_tutor'] }} / {{$data_array[0]['nama_lengkap']}} "
													       readonly>
												</div>
											</div>
										</div>
												...
												<tr>
													...
													@if($jenis != 'masa')
														<td class="center">
															...
															@else
																@if(count($ceketm) >= 5)
																	<a class="mb-3 btn-floating waves-effect waves-light gradient-45deg-purple-deep-orange gradient-shadow"
															...
															@if ((Auth::check() &&  (Auth::user()->hakakses == 'admin' ))
																...
																@if(count($ceketm) >= 5)
																	...
																	@elseif(!empty($ceketu ) && !empty($ceketm))
																		<a title=""
																		   class="mb-3 btn-floating waves-effect waves-light gradient-45deg-red-pink gradient-shadow"
																		   target="blank"
									...
									<div class="col s12 m12 l12">
										...
										<div class="row">
											<div class="input-field col s12 m12 l12">
												...
												<input placeholder="" name="tutor" id="tutor" type="text"
												       value="{{$data_array[0]['kode_matakuliah']}} / {{$data_array[0]['nama_matakuliah']}} "
												       readonly>
											</div>
										</div>
									</div>
