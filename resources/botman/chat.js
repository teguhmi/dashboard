!function (t) {
    ...
    var E = {}, k = [], D = [], U = "function" == typeof Promise ? Promise.resolve().then.bind(Promise.resolve()) : setTimeout, B = /acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i, H = [], R = [], L = 0, q = !1, I = !1, F = {};
    i(A.prototype, {
    ...
    "use strict";
    var r = n(0), o = n(15), i = n(17), a = n(18), s = n(19), c = n(5), u = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || n(20);
        ...
        return new Promise(function (e, p) {
            ...
            if (d.open(t.method.toUpperCase(), i(t.url, t.params, t.paramsSerializer), !0), d.timeout = t.timeout, d[h] = function () {
                if (d && (4 === d.readyState || m) && (0 !== d.status || d.responseURL && 0 === d.responseURL.indexOf("file:"))) {
                    ...
                    o(e, p, {data: t.responseType && "text" !== t.responseType ? d.response : d.responseText, status: 1223 === d.status ? 204 : d.status, statusText: 1223 === d.status ? "No Content" : d.statusText, headers: n, config: t, request: d}), d = null
                }
            }, d.onerror = function () {
    ...
    var r = n(10), o = n.n(r), i = function () {
        function t() {
            ...
            this.callAPI = function (e, n, r, i, a) {
                ...
                var s = new FormData, c = {driver: "web", userId: t.userId, message: e, attachment: r, interactive: n ? "1" : "0"};
    ...
    e.a = function (t) {
        ...
        return a(e, t), e.prototype.componentDidMount = function () {
            var t = this;
            !this.state.messages.length && this.props.conf.introMessage && this.writeToMessages({text: this.props.conf.introMessage, type: "text", from: "chatbot"}), window.addEventListener("message", function (e) {
                try {
            ...
            var n = this;
            return Object(r.b)("div", null, Object(r.b)("div", {id: "messageArea"}, Object(r.b)(o.a, {messages: e.messages, conf: this.props.conf, messageHandler: this.writeToMessages})), this.state.replyType === s.Text ? Object(r.b)("input", {
                id: "userText",
                class: "textarea",
                type: "text",
            ...
            })) : "", Object(r.b)("a", {class: "banner", href: this.props.conf.aboutLink, target: "_blank"}, "AboutIcon" === this.props.conf.aboutText ? Object(r.b)("svg", {
    ...
    "use strict";
    var r = n(1), o = n(42), i = (n.n(o), n(43)), a = n(44), s = n(45), c = n(46), u = n(47), p = this && this.__extends || function () {
        var t = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
            t.__proto__ = e
        } || function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n])
    ...
    e.a = function (t) {
        ...
        return p(e, t), e.prototype.componentDidMount = function () {
            ...
            var e = new Date, n = t.message, a = new Date(n.time), s = l[n.type] || i.a, c = this.props, u = c.messageHandler, p = c.conf, f = "";
            !1 !== n.visible && !1 !== n.visibilityChanged || (f += "display:none");
            var d = t.calculatedTimeout;
            return Object(r.b)("li", {"data-message-id": n.id, class: n.from, style: f}, Object(r.b)("div", {class: "msg"}, Object(r.b)(s, {
    ...
    !function () {
        ...
        var c = function () {
            var t = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZWN]|"[^"]*"|'[^']*'/g, e = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, n = /[^-+\dA-Z]/g;
            return function (r, u, p, l) {
                ...
                var d = p ? "getUTC" : "get", h = r[d + "Date"](), m = r[d + "Day"](), y = r[d + "Month"](), v = r[d + "FullYear"](), b = r[d + "Hours"](), g = r[d + "Minutes"](), _ = r[d + "Seconds"](), x = r[d + "Milliseconds"](), w = p ? 0 : r.getTimezoneOffset(), O = i(r), C = a(r), T = {
                    d: h,
                    dd: o(h),
    ...
    e.a = function (t) {
        ...
        return i(e, t), e.prototype.render = function (t) {
            ...
            return Object(r.b)("div", null, Object(r.b)("p", {dangerouslySetInnerHTML: o}), n && "image" === n.type ? Object(r.b)("img", {src: n.url, style: "max-width: 100%;"}) : "", n && "audio" === n.type ? Object(r.b)("audio", {controls: !0, autoPlay: !1, style: "max-width: 100%;"}, Object(r.b)("source", {
                src: n.url,
                type: "audio/mp3"
    ...
    e.a = function (t) {
        ...
        return a(e, t), e.prototype.render = function (t) {
            ...
            o.a.callAPI(t.value, !0, null, function (t) {
                e.state.attachmentsVisible = !1, e.props.messageHandler({text: t.text, type: t.type, timeout: t.timeout, actions: t.actions, attachment: t.attachment, additionalParameters: t.additionalParameters, from: "chatbot"})
            }, null)
        }, e
    }(i.a)
}, function (t, e, n) {
    ...
    e.a = function (t) {
        ...
        return a(e, t), e.prototype.getButton = function (t) {
            ...
            }, t.title) : "web_url" === t.type ? Object(r.b)("a", {class: "btn", href: t.url, target: "_blank"}, t.title) : void 0
        }, e.prototype.render = function (t) {
