!function (t) {
    ...
    function S(t, e, n, o) {
        if (!t._disable) {
            var r, a, s, c = t.props, u = t.state, f = t.context, l = t.prevProps || c, d = t.prevState || u, h = t.prevContext || f, m = t.base, g = t.nextBase, y = m || g, x = t._component, _ = !1;
    ...
    var T = {}, U = [], R = [], P = "function" == typeof Promise ? Promise.resolve().then.bind(Promise.resolve()) : setTimeout, F = /acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i, M = [], L = [], q = 0, H = !1, z = !1, W = {};
    i(N.prototype, {
    ...
    "use strict";
    var o = n(0), r = n(15), i = n(17), a = n(18), s = n(19), c = n(5), u = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || n(20);
    ...
    "use strict";
    var o = n(0), r = ["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"];
    t.exports = function (t) {
        var e, n, i, a = {};
    ...
    var o = {position: "fixed", bottom: "20px", right: "20px", zIndex: 2147483647, borderRadius: "5px", boxSizing: "content-box", boxShadow: "0px 0px 20px rgba(0, 0, 0, 0.2)", overflow: "hidden"},
        r = {position: "fixed", bottom: "0px", right: "0px", zIndex: 2147483647, minWidth: "400px", boxSizing: "content-box", overflow: "hidden", minHeight: "120px"}, i = {position: "fixed", bottom: "0px", right: "0px", zIndex: 2147483647, minWidth: "400px", boxSizing: "content-box", overflow: "hidden", minHeight: "120px"},
        ...
        u = {display: "block", position: "absolute", top: "46px", right: "20px", height: "52px", width: "52px", border: 0, borderRadius: "50%", boxShadow: "0px 0px 20px rgba(0, 0, 0, 0.2)"}, p = {width: "100%", height: "auto", borderRadius: "999px"}
}, function (t, e, n) {
    "use strict";
    ...
    "use strict";
    var o = n(10), r = n.n(o), i = n(1), a = n(32), s = n(33), c = n(34), u = n(35), p = n(36), f = n(29), l = this && this.__extends || function () {
    ...
    e.a = function (t) {
        ...
        return l(e, t), e.prototype.componentDidMount = function () {
            ...
            var n = t.conf, o = t.isMobile, r = e.isChatOpen, p = e.pristine, l = {width: o ? n.mobileWidth : n.desktopWidth}, h = window.innerHeight - 100 < n.desktopHeight ? window.innerHeight - 90 : n.desktopHeight;
            n.wrapperHeight = h;
            var m;
            return m = r || !o && !n.alwaysUseFloatingButton ? o ? f.h : (r || this.state.wasChatOpened) && r ? d({}, f.e, l) : d({}, f.c) : d({}, f.g), Object(i.b)("div", {style: m}, !o && !n.alwaysUseFloatingButton || r ? (r || this.state.wasChatOpened) && r ? Object(i.b)("div", {
                ...
                onClick: this.toggle
            }, Object(i.b)("div", {style: {display: "flex", alignItems: "center", padding: "0px 30px 0px 0px", fontSize: "15px", fontWeight: "normal", color: n.headerTextColor}}, n.title), Object(i.b)(u.a, {isOpened: r})) : Object(i.b)(c.a, {onClick: this.toggle, conf: n}) : Object(i.b)(s.a, {
                onClick: this.toggle,
                conf: n
    ...
    e.a = function (t) {
        ...
        return r(e, t), e.prototype.shouldComponentUpdate = function () {
            ...
            var e = t.iFrameSrc, n = t.isMobile, r = t.conf, a = window.botmanWidget || {}, s = encodeURIComponent(JSON.stringify(i({}, r, a)));
    ...
    e.a = function (t) {
        ...
        return i(e, t), e.prototype.render = function (t) {
            var e = t.conf;
            return Object(o.b)("div", {style: {position: "relative", cursor: "pointer"}, onClick: this.props.onClick}, Object(o.b)("div", {className: "mobile-closed-message-avatar", style: a({background: e.bubbleBackground}, r.f)}, "" === e.bubbleAvatarUrl ? Object(o.b)("svg", {
                style: {paddingTop: 4},
                fill: "#FFFFFF",
                height: "24",
                viewBox: "0 0 24 24",
            ...
            }, Object(o.b)("path", {d: "M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 9h12v2H6V9zm8 5H6v-2h8v2zm4-6H6V6h12v2z"}), Object(o.b)("path", {d: "M0 0h24v24H0z", fill: "none"})) : -1 !== e.bubbleAvatarUrl.indexOf("/") ? Object(o.b)("img", {
    ...
    e.a = function (t) {
        ...
        return i(e, t), e.prototype.render = function (t) {
            var e = t.conf;
            return Object(o.b)("div", {style: {position: "relative", cursor: "pointer"}, onClick: this.props.onClick}, Object(o.b)("div", {className: "desktop-closed-message-avatar", style: a({background: e.bubbleBackground}, r.b)}, "" === e.bubbleAvatarUrl ? Object(o.b)("svg", {
                ...
                fill: "#fff"
            })) : -1 !== e.bubbleAvatarUrl.indexOf("/") ? Object(o.b)("img", {src: e.bubbleAvatarUrl, style: a({}, r.a)}) : Object(o.b)("div", {style: {display: "flex", alignItems: "center"}}, Object(o.b)("br", null), e.bubbleAvatarUrl)))
        }, e
    }(o.a)
}, function (t, e, n) {
    "use strict";
    ...
    e.a = function (t) {
        ...
        return r(e, t), e.prototype.render = function (t) {
            var e = t.isOpened;
            return Object(o.b)("div", null, e ? Object(o.b)("svg", {style: {marginRight: 15, marginTop: 6, verticalAlign: "middle"}, fill: "#FFFFFF", height: "15", viewBox: "0 0 15 15", width: "15", xmlns: "http://www.w3.org/2000/svg"}, Object(o.b)("line", {
                x1: "1",
                y1: "15",
                x2: "15",
                y2: "1",
                stroke: "white",
                "stroke-width": "1"
            }), Object(o.b)("line", {x1: "1", y1: "1", x2: "15", y2: "15", stroke: "white", "stroke-width": "1"})) : Object(o.b)("svg", {
