...
class NumpangUjianModel extends Model
{
    use HasFactory;
...
//                GROUP BY a.hari,a.masa";
    ...
    public static function updateNomorSurat($data_array, $ids)
    {
    ...
    public static function cekData($nim, $masa,$jenis)
    {

        $sql = "SELECT  * from ujian_numpang as a where a.nim = '$nim' and a.masa = '$masa' and a.jenis = '$jenis'";
        $results = DB::connection(self::$db)
            ->select(DB::raw($sql));
        return $results;
    }
    ...
    public static function getTPUTujuan($masa, $nim, $jenis)
    {
        $sql = "SELECT * from ujian_numpang_tpu as a where a.masa = '$masa' and a.nim = '$nim' and a.jenis = '$jenis'";
        $results = DB::connection(self::$db)
            ->select(DB::raw($sql));
        return $results;
    }
...
//                GROUP BY a.id, a.masa, a.nim, a.hari, a.jam_ujian, a.kode_mtk, a.kode_upbjj_ujian_asal, a.nama_wilayah_ujian_asal,b.kode_tempat_ujian_tujuan,b.nama_wilayah_ujian_tujuan";
        $sql = "SELECT a.masa, a.hari, c.kode_upbjj_ujian_tujuan, c.nama_upbjj_ujian_tujuan, c.kode_tempat_ujian_tujuan, c.nama_wilayah_ujian_tujuan,
                ...
                FROM ujian_numpang AS a
                JOIN ujian_numpang_tpu AS c ON a.nim = c.nim AND a.hari = c.hari and a.masa = c.masa
                WHERE a.masa = '$masa' AND a.nim = '$nim' and a.hari = c.hari
    ...
    public static function getDaftarNumpangUjian($id, $kodeupbjj)
    {
        $sql = "SELECT a.masa, a.nim, c.nama_mahasiswa, a.hari, c.kode_upbjj_ujian_tujuan, c.nama_upbjj_ujian_tujuan, c.kode_tempat_ujian_tujuan, c.nama_wilayah_ujian_tujuan,
                (SELECT j1.kode_mtk FROM ujian_numpang AS j1 WHERE j1.jam_ujian = 1 AND j1.hari = a.hari AND j1.nim = a.nim AND j1.masa = a.masa) AS kode_mtk_1,
                (SELECT j1.kode_mtk FROM ujian_numpang AS j1 WHERE j1.jam_ujian = 2 AND j1.hari = a.hari AND j1.nim = a.nim AND j1.masa = a.masa) AS kode_mtk_2,
                (SELECT j1.kode_mtk FROM ujian_numpang AS j1 WHERE j1.jam_ujian = 3 AND j1.hari = a.hari AND j1.nim = a.nim AND j1.masa = a.masa) AS kode_mtk_3,
                (SELECT j1.kode_mtk FROM ujian_numpang AS j1 WHERE j1.jam_ujian = 4 AND j1.hari = a.hari AND j1.nim = a.nim AND j1.masa = a.masa) AS kode_mtk_4,
                ...
                WHERE a.masa = '$id' AND c.kode_upbjj_ujian_tujuan = '$kodeupbjj' and a.hari = c.hari
                GROUP BY a.hari, c.kode_tempat_ujian_tujuan, a.nim,c.nama_mahasiswa,a.masa,  c.kode_upbjj_ujian_tujuan, c.nama_upbjj_ujian_tujuan,  c.nama_wilayah_ujian_tujuan
                ORDER BY a.hari, c.nama_wilayah_ujian_tujuan, c.nama_mahasiswa";
        $results = DB::connection(self::$db)
            ->select(DB::raw($sql));
        return $results;
    }
    ...
    public static function get_jumlahmatakuliah($id, $kodeupbjj)
    {
        $sql = "SELECT a.masa, a.hari, a.kode_upbjj_ujian_tujuan, a.nama_upbjj_ujian_tujuan,
                a.kode_tempat_ujian_tujuan, a.nama_wilayah_ujian_tujuan,
                (SELECT CONCAT (b.kode_mtk, '=' , COUNT(b.kode_mtk)) AS M1 FROM ujian_numpang AS b WHERE b.masa= a.masa AND b.hari = a.hari AND b.nim = a.nim AND b.jam_ujian = 1 GROUP BY b.kode_mtk,b.nim) AS jam_1,
                (SELECT CONCAT (b.kode_mtk, '=' , COUNT(b.kode_mtk)) AS M1 FROM ujian_numpang AS b WHERE b.masa= a.masa AND b.hari = a.hari AND b.nim = a.nim AND b.jam_ujian = 2 GROUP BY b.kode_mtk,b.nim) AS jam_2,
                (SELECT CONCAT (b.kode_mtk, '=' , COUNT(b.kode_mtk)) AS M1 FROM ujian_numpang AS b WHERE b.masa= a.masa AND b.hari = a.hari AND b.nim = a.nim AND b.jam_ujian = 3 GROUP BY b.kode_mtk,b.nim) AS jam_3,
                (SELECT CONCAT (b.kode_mtk, '=' , COUNT(b.kode_mtk)) AS M1 FROM ujian_numpang AS b WHERE b.masa= a.masa AND b.hari = a.hari AND b.nim = a.nim AND b.jam_ujian = 4 GROUP BY b.kode_mtk,b.nim) AS jam_4,
                (SELECT CONCAT (b.kode_mtk, '=' , COUNT(b.kode_mtk)) AS M1 FROM ujian_numpang AS b WHERE b.masa= a.masa AND b.hari = a.hari AND b.nim = a.nim AND b.jam_ujian = 5 GROUP BY b.kode_mtk,b.nim) AS jam_5
                FROM ujian_numpang_tpu AS a
                WHERE a.masa = '$id' AND a.kode_upbjj_ujian_tujuan = '$kodeupbjj' AND a.nim IN (SELECT c.nim FROM ujian_numpang AS c WHERE c.masa = a.masa)
                GROUP BY a.masa, a.nim, a.hari,  a.kode_upbjj_ujian_tujuan, a.nama_upbjj_ujian_tujuan,
                a.kode_tempat_ujian_tujuan, a.nama_wilayah_ujian_tujuan
                ORDER BY a.hari, a.kode_upbjj_ujian_tujuan,  a.kode_tempat_ujian_tujuan
 ";
        $results = DB::connection(self::$db)
            ->select(DB::raw($sql));
        return $results;
    ...
    public function get_all_tpu() {
        $sql = "select * from ujian_numpang_tpu where nama_mahasiswa is NULL limit 50";
        $results = DB::connection(self::$db)
            ->select(DB::raw($sql));
        return $results;
    }
    public static function insert_nama($nim, $data_array)
    {
        $results = DB::table('ujian_numpang_tpu')
            ->where('nim', $nim)
            ->update($data_array);
