            ...
            <div class="breadcrumbs-dark pb-0 pt-2" id="breadcrumbs-wrapper">
                <div class="row">
                    <div class="col s10 m6 l6">
                        <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>Administrasi Numpang Ujian Masuk</span></h5>
                            ...
                            <div class="col s12">
                                <div id="basic-form" class="card card-default scrollspy">
                                    <div class="card-content">
                                        <h4 class="card-title">Menumpang Ujian Masuk</h4>
                                        <form role="form" method="post" action="{{route('ujian.numpangmasuk.cari')}}" id="form">
                                            @csrf
                                            <div class="row">
                                                ...
                                                {{--                                                    <input placeholder='dd/mm/yyyy' name='tgl_lahir' id='tgl_lahir' type="text">--}}

                                                {{--                                                </div>--}}
                                                {{--                                                <div class="input-field col s12 m6 l6">--}}
                                                {{--                                                    <label label for="captcha">Captcha</label>--}}
                                                ...
                                                {{--                                                        <button type="button" class="mb-6 btn-floating waves-effect waves-light gradient-45deg-purple-deep-orange" id="reload">--}}
                                        ...
                                        <div class="row">
                                            <div class="col s12">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>  <a class="waves-effect waves-light btn gradient-45deg-green-teal"
                                                                 href="{{route('ujian.numpangmasuk')}}">Buat Baru
                                                            </a>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <select class="select2 browser-default" name="upbjj" id="upbjj">
                                                            ...
                                                            @if (!empty($upbjj))
                                                                @foreach ($upbjj->data->dataUpbjj as $data)
                                                                    @if($data->kode_upbjj == config('app.kode_upbjj'))
                        ...
                        <div id="basic-form" class="card card card-default scrollspy">
                            <div class="card-content">
                                ...
                                <a class="waves-effect waves-light btn gradient-45deg-green-teal right btn-small "
                                   href="{{route('ujian.numpangmasuk.getd20an', ['id' => Crypt::encrypt($DPMahasiswa['nim'])]) }}">Ambil Matakuliah
                                </a>
...
@section('script')
    ...
    <script src="{{url ("app-assets/js/jquery.maskedinput.js") }}"></script>
    <script type="text/javascript">
